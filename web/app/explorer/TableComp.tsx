...
const TableComp = ({
  ...
  if (!selectedTable)
    return (
      <div className="w-full h-full max-h-full max-w-full bg-gray-800 border-l border-gray-600 text-gray-400 text-sm overflow-auto overflow-x-scroll height-adjust-25 flex justify-items-center items-center">
